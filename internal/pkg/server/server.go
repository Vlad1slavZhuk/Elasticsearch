...
import (
	"Elasticsearch/internal/pkg/config"
	"Elasticsearch/internal/pkg/graphql/graph"
	"Elasticsearch/internal/pkg/graphql/graph/generated"
	"Elasticsearch/internal/pkg/grpc"
	"Elasticsearch/internal/pkg/service"
	"context"
	"log"
	"net/http"
	"os"
